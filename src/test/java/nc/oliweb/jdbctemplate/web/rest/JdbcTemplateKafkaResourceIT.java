...
public class JdbcTemplateKafkaResourceIT {
    ...
    @Autowired
    private JdbcTemplateKafkaProducer producer;

    @Autowired
    private JdbcTemplateKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        JdbcTemplateKafkaResource kafkaResource = new JdbcTemplateKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/jdbc-template-kafka/publish?message=test"))
